...
#define WM_CONNECTION_STATE_REFRESH (WM_USER+1011)  //由UI线程刷新连接状态
#define WM_NETWORK_INFO_IP_UPDATED (WM_USER+1012)   //公网IP查询完成

#define WM_NEXT_USER_MSG (WM_USER+1013)
